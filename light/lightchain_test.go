...
func makeHeaderChain(parent *types.Header, n int, db lolodb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (lolodb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() lolodb.Database {
	return odr.db
}
