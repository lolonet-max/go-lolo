...
func (mc *mockCaller) CallContract(ctx context.Context, call lolo.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call lolo.CallMsg) ([]byte, error) {
