...
//
// Detailed usage document and tutorial available on the go-lolo Wiki page:
// https://github.com/lolo/go-lolo/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
...
func bindTopicTypeGo(kind abi.Type, structs map[string]*tmplStruct) string {
	...
	// parameters that are not value types i.e. arrlolo and structs are not
...
func bindStructTypeGo(kind abi.Type, structs map[string]*tmplStruct) string {
	...
	case abi.TupleTy:
		...
		// tololoer here. The reason is before solidity v0.5.11, kind.TupleRawName
		// is empty, so we use canonical parameter expression to distinguish
		// different struct definition. From the consideration of backward
		// compatibility, we concat these two tololoer so that if kind.TupleRawName
