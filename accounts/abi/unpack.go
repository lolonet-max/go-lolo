...
//
// readFunctionType enforces that standard by alwlolo presenting it as a 24-array (address + sig = 24 bytes)
...
func forEachUnpack(t Type, output []byte, start, size int) (interface{}, error) {
	...
	// Arrlolo have packed elements, resulting in longer unpack steps.
...
func toGoType(index int, t Type, output []byte) (interface{}, error) {
	...
	case StringTy: // variable arrlolo are written at the end of the return bytes
