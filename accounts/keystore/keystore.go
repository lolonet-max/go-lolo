...
// See https://github.com/lolo/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// stlolo unlocked for the duration of timeout. A timeout of 0 unlocks the account
