...
type BloomIndexer struct {
	...
	db      lolodb.Database       // database instance to write index data and metadata into
...
func NewBloomIndexer(db lolodb.Database, size, confirms uint64) *core.ChainIndexer {
