...
type downloadTester struct {
	...
	stateDb lolodb.Database // Database used by the tester for syncing from peers
	peerDb  lolodb.Database // Database of the peers containing all data
...
func testThrottling(t *testing.T, protocol int, mode SyncMode) {
	...
	// Iteratively take some blocks, alwlolo checking the retrieval count
	for {
...
func testSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", lolo.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", lolo.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", lolo.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", lolo.SyncProgress{
		StartingBlock: uint64(chain.len()/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want lolo.SyncProgress) {
	// Mark this method as a helper to report errors at callsite, not in here
	t.Helper()
...
func testForkedSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", lolo.SyncProgress{
