...
import (
	...
	"github.com/lolo/go-lolo/accounts/scwallet"
...
//
// https://github.com/lolo/go-lolo/wiki/Management-APIs#personal_sign
...
//
// https://github.com/lolo/go-lolo/wiki/Management-APIs#personal_ecRecover
...
// Unpair deletes a pairing between wallet and lolo.
...
func (s *PublicBlockChainAPI) BlockNumber() hexutil.Uint64 {
	header, _ := s.b.HeaderByNumber(context.Background(), rpc.LatestBlockNumber) // latest header should alwlolo be available
...
//
// https://github.com/lolo/wiki/wiki/JSON-RPC#eth_sign
...
// Version returns the current lolo protocol version.
