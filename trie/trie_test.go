...
func (s *spongeDb) NewBatch() lolodb.Batch                    { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) lolodb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w lolodb.KeyValueWriter) error { return nil }
