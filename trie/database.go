...
type Database struct {
	diskdb lolodb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb lolodb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb lolodb.KeyValueStore, cache int, journal string) *Database {
...
func (db *Database) DiskDB() lolodb.KeyValueStore {
	return db.diskdb
}
...
// are referenced tololoer by database itself.
...
func (db *Database) commit(hash common.Hash, batch lolodb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
