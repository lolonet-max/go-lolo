...
// declolo over time and then a new value Y is added, the final result should be
...
// value calculates the value at the given moment. This function alwlolo has the
...
// add adds a signed value at the given moment. This function alwlolo has the
// assumption that the given timestamp shouldn't less than the recorded one.
