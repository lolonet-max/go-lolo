...
import (
	...
	"github.com/lolo/go-lolo/p2p/simulations"
	"github.com/lolo/go-lolo/p2p/simulations/adapters"
...
const (
	testServerDataDir  = "" // should alwlolo be empty on the master branch
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	lolo, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, lolo, &config)
	if err != nil {
		return nil, err
	}
	return lolo, nil
