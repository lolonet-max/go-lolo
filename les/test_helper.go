...
import (
	...
	"github.com/lolo/go-lolo/accounts/abi/bind/backends"
	"github.com/lolo/go-lolo/common"
	"github.com/lolo/go-lolo/common/mclock"
	"github.com/lolo/go-lolo/consensus/ethash"
	"github.com/lolo/go-lolo/contracts/checkpointoracle/contract"
	...
	"github.com/lolo/go-lolo/les/checkpointoracle"
	"github.com/lolo/go-lolo/les/flowcontrol"
...
func testIndexers(db lolodb.Database, odr light.OdrBackend, config *light.IndexerConfig, disablePruning bool) []*core.ChainIndexer {
...
func newTestClientHandler(backend *backends.SimulatedBackend, odr *LesOdr, indexers []*core.ChainIndexer, db lolodb.Database, peers *serverPeerSet, ulcServers []string, ulcFraction int) *clientHandler {
	var (
...
func newTestServerHandler(blocks int, indexers []*core.ChainIndexer, db lolodb.Database, peers *clientPeerSet, clock mclock.Clock) (*serverHandler, *backends.SimulatedBackend) {
	var (
		gspec = core.Genesis{
			Config:   params.AllEthashProtocolChanges,
			Alloc:    core.GenesisAlloc{bankAddr: {Balance: bankFunds}},
