...
// Package utils contains internal helper functions for go-lolo commands.
package utils
...
import (
	...
	"github.com/lolo/go-lolo/accounts"
	"github.com/lolo/go-lolo/accounts/keystore"
	"github.com/lolo/go-lolo/common"
	"github.com/lolo/go-lolo/common/fdlimit"
	"github.com/lolo/go-lolo/consensus"
	"github.com/lolo/go-lolo/consensus/clique"
	"github.com/lolo/go-lolo/consensus/ethash"
	"github.com/lolo/go-lolo/core"
	"github.com/lolo/go-lolo/core/rawdb"
	"github.com/lolo/go-lolo/core/vm"
	"github.com/lolo/go-lolo/crypto"
	"github.com/lolo/go-lolo/eth"
	"github.com/lolo/go-lolo/eth/downloader"
	"github.com/lolo/go-lolo/eth/gasprice"
	"github.com/lolo/go-lolo/lolodb"
	"github.com/lolo/go-lolo/lolotats"
	"github.com/lolo/go-lolo/graphql"
	"github.com/lolo/go-lolo/internal/ethapi"
	"github.com/lolo/go-lolo/internal/flags"
	"github.com/lolo/go-lolo/les"
	"github.com/lolo/go-lolo/log"
	"github.com/lolo/go-lolo/metrics"
	"github.com/lolo/go-lolo/metrics/exp"
	"github.com/lolo/go-lolo/metrics/influxdb"
	"github.com/lolo/go-lolo/miner"
	"github.com/lolo/go-lolo/node"
	"github.com/lolo/go-lolo/p2p"
	"github.com/lolo/go-lolo/p2p/discv5"
	"github.com/lolo/go-lolo/p2p/enode"
	"github.com/lolo/go-lolo/p2p/nat"
	"github.com/lolo/go-lolo/p2p/netutil"
...
var (
	...
	EthStatsURLFlag = cli.StringFlag{
		Name:  "lolotats",
		Usage: "Reporting URL of a lolotats service (nodename:secret@host:port)",
	}
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `lolo account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetShhConfig(ctx *cli.Context, stack *node.Node) {
	if ctx.GlobalIsSet(WhisperEnabledFlag.Name) ||
		...
		log.Warn("Whisper support has been deprecated and the code has been moved to github.com/lolo/whisper")
	}
}
...
func RegisterEthStatsService(stack *node.Node, backend ethapi.Backend, url string) {
	if err := lolotats.New(stack, backend, backend.Engine(), url); err != nil {
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "lolo.", tagsMap)
		}
...
func MakeChainDatabase(ctx *cli.Context, stack *node.Node) lolodb.Database {
	var (
		cache   = ctx.GlobalInt(CacheFlag.Name) * ctx.GlobalInt(CacheDatabaseFlag.Name) / 100
		handles = makeDatabaseHandles()

		err     error
		chainDb lolodb.Database
	)
...
func MakeChain(ctx *cli.Context, stack *node.Node, readOnly bool) (chain *core.BlockChain, chainDb lolodb.Database) {
	var err error
	chainDb = MakeChainDatabase(ctx, stack)
...
// new format.
//
// e.g. lolo account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// lolo --keystore /tmp/mykeystore --lightkdf account new
//
