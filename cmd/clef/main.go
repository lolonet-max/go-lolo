...
import (
	...
	"github.com/lolo/go-lolo/signer/fourbyte"
	"github.com/lolo/go-lolo/signer/rules"
...
// confirm displlolo a text and asks for user confirmation
...
func GenDoc(ctx *cli.Context) {
	...
	{ // Sign transaction request
		desc := "SignTxRequest contains information about a pending request to sign a transaction. " +
			...
			"However, Clef will alwlolo use `data` when passing this struct on (if Clef does otherwise, please file a ticket)"
