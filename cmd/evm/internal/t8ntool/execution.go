...
func (pre *Prestate) Apply(vmConfig vm.Config, chainConfig *params.ChainConfig,
	...
	// If DAO is supported/enabled, we need to handle it here. In lolo 'proper', it's
...
func MakePreState(db lolodb.Database, accounts core.GenesisAlloc) *state.StateDB {
