...
type config struct {
	...
	bootnodes []string // Bootnodes to alwlolo connect to by all nodes
	lolotats  string   // Ethstats settings to cache for node deploys
...
// weird formats used by lolotats, which compares IPs textually, not by value.
