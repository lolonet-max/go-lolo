...
// manageServers displlolo a list of servers the user can disconnect from, and an
...
// manageComponents displlolo a list of network components the user can tear down
// and an option
...
// deployComponent displlolo a list of network components the user can deploy and
