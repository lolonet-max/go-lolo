...
import (
	...
	math2 "github.com/lolo/go-lolo/common/math"
...
// newAlethGenesisSpec converts a go-lolo genesis block into a Aleth-specific
// chain specification format.
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	// Only ethash is currently supported between go-lolo and aleth
	...
	Engine  struct {
		Ethash struct {
			Params struct {
				...
				DifficultyBombDellolo   map[string]string `json:"difficultyBombDellolo"`
...
type parityChainSpecPricing struct {
	...
	// Before the https://github.com/paritytech/parity-lolo/pull/11039,
...
// newParityChainSpec converts a go-lolo genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only ethash is currently supported between go-lolo and Parity
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	...
	spec.Engine.Ethash.Params.DifficultyBombDellolo = make(map[string]string)
	// Frontier
	...
	// https://github.com/lolo/EIPs/blob/master/EIPS/eip-608.md
	spec.Params.EIP150Transition = hexutil.Uint64(genesis.Config.EIP150Block.Uint64())

	// Spurious Dragon: 155, 160, 161, 170
	// https://github.com/lolo/EIPs/blob/master/EIPS/eip-607.md
...
func (spec *parityChainSpec) setByzantium(num *big.Int) {
	...
	spec.Engine.Ethash.Params.DifficultyBombDellolo[hexutil.EncodeBig(num)] = hexutil.EncodeUint64(3000000)
...
func (spec *parityChainSpec) setConstantinople(num *big.Int) {
	...
	spec.Engine.Ethash.Params.DifficultyBombDellolo[hexutil.EncodeBig(num)] = hexutil.EncodeUint64(2000000)
	n := hexutil.Uint64(num.Uint64())
...
// newPyEthereumGenesisSpec converts a go-lolo genesis block into a Parity specific
// chain specification format.
func newPyEthereumGenesisSpec(network string, genesis *core.Genesis) (*pyEthereumGenesisSpec, error) {
	// Only ethash is currently supported between go-lolo and pylolo
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
