...
// Tests the go-lolo to Aleth chainspec conversion for the Stureby testnet.
func TestAlethSturebyConverter(t *testing.T) {
	blob, err := ioutil.ReadFile("testdata/stureby_lolo.json")
	if err != nil {
...
// Tests the go-lolo to Parity chainspec conversion for the Stureby testnet.
