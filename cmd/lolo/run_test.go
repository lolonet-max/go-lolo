...
import (
	...
	"github.com/lolo/go-lolo/internal/cmdtest"
	"github.com/lolo/go-lolo/rpc"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "lolo-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "lolo-test" in runGeth.
	reexec.Register("lolo-test", func() {
...
// spawns lolo with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runGeth(t *testing.T, args ...string) *testlolo {
	tt := &testlolo{}
	...
	// Boot "lolo". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("lolo-test", args...)
