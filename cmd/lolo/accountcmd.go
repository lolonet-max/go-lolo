...
var (
	walletCommand = cli.Command{
		...
		Description: `
    lolo wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	lolo wallet [options] /path/to/my/presale.wallet
...
between lolo nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    lolo account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    lolo account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another lolo instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := loloConfig{Node: defaultNodeConfig()}
	// Load config file.
