...
import (
	...
	"github.com/lolo/go-lolo/signer/core"
	"github.com/lolo/go-lolo/signer/storage"
)
...
type alwloloDenyUI struct{}

func (alwloloDenyUI) OnInputRequired(info core.UserInputRequest) (core.UserInputResponse, error) {
	return core.UserInputResponse{}, nil
}
func (alwloloDenyUI) RegisterUIServer(api *core.UIServerAPI) {
}

func (alwloloDenyUI) OnSignerStartup(info core.StartupInfo) {
}

func (alwloloDenyUI) ApproveTx(request *core.SignTxRequest) (core.SignTxResponse, error) {
	return core.SignTxResponse{Transaction: request.Transaction, Approved: false}, nil
}

func (alwloloDenyUI) ApproveSignData(request *core.SignDataRequest) (core.SignDataResponse, error) {
	return core.SignDataResponse{Approved: false}, nil
}

func (alwloloDenyUI) ApproveListing(request *core.ListRequest) (core.ListResponse, error) {
	return core.ListResponse{Accounts: nil}, nil
}

func (alwloloDenyUI) ApproveNewAccount(request *core.NewAccountRequest) (core.NewAccountResponse, error) {
	return core.NewAccountResponse{Approved: false}, nil
}

func (alwloloDenyUI) ShowError(message string) {
	panic("implement me")
}

func (alwloloDenyUI) ShowInfo(message string) {
	panic("implement me")
}

func (alwloloDenyUI) OnApprovedTx(tx ethapi.SignTransactionResult) {
	panic("implement me")
}

func initRuleEngine(js string) (*rulesetUI, error) {
	r, err := NewRuleEvaluator(&alwloloDenyUI{}, storage.NewEphemeralStorage())
	if err != nil {
