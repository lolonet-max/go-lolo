...
import (
	...
	"github.com/lolo/go-lolo/internal/jsre"
	"github.com/lolo/go-lolo/internal/jsre/deps"
	"github.com/lolo/go-lolo/internal/web3ext"
...
func (c *Console) initExtensions() error {
	...
	aliases := map[string]struct{}{"lolo": {}, "personal": {}}
	for api := range apis {
		if api == "web3" {
			continue
		}
...
func (c *Console) Welcome() {
	message := "Welcome to the lolo JavaScript console!\n\n"
