...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "lolo.ipc", false, filepath.Join(os.TempDir(), "lolo.ipc")},
		{"data", "lolo.ipc", false, "data/lolo.ipc"},
		{"data", "./lolo.ipc", false, "./lolo.ipc"},
		{"data", "/lolo.ipc", false, "/lolo.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "lolo.ipc", true, `\\.\pipe\lolo.ipc`},
		{"data", "lolo.ipc", true, `\\.\pipe\lolo.ipc`},
		{"data", `\\.\pipe\lolo.ipc`, true, `\\.\pipe\lolo.ipc`},
	}
