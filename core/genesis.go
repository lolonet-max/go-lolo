...
func SetupGenesisBlock(db lolodb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) ToBlock(db lolodb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db lolodb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db lolodb.Database) *types.Block {
...
func GenesisBlockForTesting(db lolodb.Database, addr common.Address, balance *big.Int) *types.Block {
...
// DeveloperGenesisBlock returns the 'lolo --dev' genesis block.
