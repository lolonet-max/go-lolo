...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (lolodb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (lolodb.Database, func()) {
...
//
// https://github.com/lolo/go-lolo/pull/15941
...
//
// Details at:
//  - https://github.com/lolo/go-lolo/issues/18977
//  - https://github.com/lolo/go-lolo/pull/18988
