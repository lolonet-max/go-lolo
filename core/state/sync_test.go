...
// account array.
func checkStateAccounts(t *testing.T, db lolodb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db lolodb.Database, root common.Hash) error {
...
func checkStateConsistency(db lolodb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(lolodb.Database), srcRoot)
