...
type Tree struct {
	diskdb lolodb.KeyValueStore      // Persistent database to store the snapshot
...
// background thread.
func New(diskdb lolodb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool) *Tree {
