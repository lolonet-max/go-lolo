...
func ReadDatabaseVersion(db lolodb.KeyValueReader) *uint64 {
	var version uint64
...
func WriteDatabaseVersion(db lolodb.KeyValueWriter, version uint64) {
...
func ReadChainConfig(db lolodb.KeyValueReader, hash common.Hash) *params.ChainConfig {
...
func WriteChainConfig(db lolodb.KeyValueWriter, hash common.Hash, cfg *params.ChainConfig) {
	if cfg == nil {
		return
	}
