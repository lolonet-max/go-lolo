...
import (
	...
	"github.com/lolo/go-lolo/lolodb/leveldb"
	"github.com/lolo/go-lolo/lolodb/memorydb"
...
func NewDatabase(db lolodb.KeyValueStore) lolodb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db lolodb.KeyValueStore, freezer string, namespace string) (lolodb.Database, error) {
...
func NewMemoryDatabase() lolodb.Database {
...
func NewMemoryDatabaseWithCap(size int) lolodb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (lolodb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (lolodb.Database, error) {
...
func InspectDatabase(db lolodb.Database) error {
