...
func NewTable(db lolodb.Database, prefix string) lolodb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) lolodb.Iterator {
...
func (t *table) NewBatch() lolodb.Batch {
...
func (b *tableBatch) Replay(w lolodb.KeyValueWriter) error {
...
// Release releases associated resources. Release should alwlolo succeed and can
